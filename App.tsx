                  ...
                  <div id="services" className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                    {SERVICES.map((service, index) => (
                      <AnimatedSection key={service.id} animation="scale-in" delay={index * 100}>
                        <div className="group p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-accent/50 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {PROJECTS.map((project, index) => (
                <AnimatedSection key={project.id} animation="fade-in-up" delay={index * 150}>
                  <div className="group relative bg-gray-900 rounded-2xl overflow-hidden border border-gray-800 hover:border-gray-600 transition-all duration-500">
