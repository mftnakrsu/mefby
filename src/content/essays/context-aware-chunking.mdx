...
The pooling step is almost embarrassingly simple. Here is the function from the companion code ([context_aware_chunking.py](/essays/context-aware-chunking/context_aware_chunking.py), which scores all three approaches on this exact refund note), verbatim:
