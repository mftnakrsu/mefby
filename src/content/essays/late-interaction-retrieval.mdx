...
In numpy it is barely longer than the sentence. Here is the function exactly as it ships in [rag_maxsim.py](/essays/late-interaction-retrieval/rag_maxsim.py), the runnable companion for this part:
...
The fastest way to feel why MaxSim behaves the way it does is to perturb the worked example in [rag_maxsim.py](/essays/late-interaction-retrieval/rag_maxsim.py) and watch the score move.
