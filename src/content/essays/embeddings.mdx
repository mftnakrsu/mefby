...
{/* author: optionally drop a first-person "From experience" callout here, e.g. the first time an embedding model's results surprised you, formatted as a > 💡 **From experience** blockquote. */}
