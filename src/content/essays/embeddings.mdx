...
- Mikolov, T., Chen, K., Corrado, G., & Dean, J. (2013). *Efficient Estimation of Word Representations in Vector Space.* arXiv:1301.3781. [arxiv.org/abs/1301.3781](https://arxiv.org/abs/1301.3781) (word2vec; the home of `king − man + woman ≈ queen`.)
- Pennington, J., Socher, R., & Manning, C.D. (2014). *GloVe: Global Vectors for Word Representation.* EMNLP 2014, pp. 1532–1543. [aclanthology.org/D14-1162](https://aclanthology.org/D14-1162/)
- Muennighoff, N., Tazi, N., Magne, L., & Reimers, N. (2022). *MTEB: Massive Text Embedding Benchmark.* arXiv:2210.07316. [arxiv.org/abs/2210.07316](https://arxiv.org/abs/2210.07316)
