...
*RAG from First Principles. Part 8 of the series.*
...
3. **Retrieve wide** with hybrid search (Part 7): pull a generous candidate set so recall is high.
