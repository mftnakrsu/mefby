...
Here is the controller verbatim from the runnable artifact, [rag_agent.py](/essays/rag-agent/rag_agent.py). It takes the goal and the list of prior steps and returns the next step as a Thought, a tool name, and an argument:
