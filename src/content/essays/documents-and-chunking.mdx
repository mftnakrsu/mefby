...
*RAG from First Principles. Part 5 of the series.*
...
**Fixed-size chunking** splits the text every `N` tokens or characters, full stop. It is the simplest, fastest, and most predictable approach, and it is blind: it will happily cut through the middle of a sentence, a word, or an idea, because it counts characters and nothing else. Good for a quick baseline, rough on meaning.
